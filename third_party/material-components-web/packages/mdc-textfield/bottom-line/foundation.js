goog.module('mdc.textfield.bottomline.foundation');
...
const MDCTextFieldBottomLineAdapter = goog.require('mdc.textfield.bottomline.adapter');

const {
  cssClasses,
  strings,
} = goog.require('mdc.textfield.bottomline.constants');
...
exports = MDCTextFieldBottomLineFoundation;