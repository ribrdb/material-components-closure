...
const {
  MDCRipple,
  MDCRippleFoundation,
} = goog.require('mdc.ripple');

const {
  getMatchesProperty,
} = goog.require('mdc.ripple.util');

const {
  cssClasses,
  strings,
} = goog.require('mdc.textfield.constants');

const {
  MDCTextFieldAdapter,
  FoundationMapType,
} = goog.require('mdc.textfield.adapter');

const MDCTextFieldFoundation = goog.require('mdc.textfield.foundation');

/* eslint-disable no-unused-vars */
const {
  MDCTextFieldBottomLine,
  MDCTextFieldBottomLineFoundation,
} = goog.require('mdc.textfield.bottomline');

const {
  MDCTextFieldHelperText,
  MDCTextFieldHelperTextFoundation,
} = goog.require('mdc.textfield.helpertext');

const {
  MDCTextFieldIcon,
  MDCTextFieldIconFoundation,
} = goog.require('mdc.textfield.icon');

const {
  MDCTextFieldLabel,
  MDCTextFieldLabelFoundation,
} = goog.require('mdc.textfield.label');
