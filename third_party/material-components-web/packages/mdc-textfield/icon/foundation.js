goog.module('mdc.textfield.icon.foundation');
...
const MDCTextFieldIconAdapter = goog.require('mdc.textfield.icon.adapter');

const {
  strings,
} = goog.require('mdc.textfield.icon.constants');
...
exports = MDCTextFieldIconFoundation;