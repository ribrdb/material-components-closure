goog.module('mdc.menu.simple.foundation');
...
const MDCSimpleMenuAdapter = goog.require('mdc.menu.simple.adapter');

const {
  cssClasses,
  strings,
  numbers,
} = goog.require('mdc.menu.simple.constants');

const {
  clamp,
  bezierProgress,
} = goog.require('mdc.menu.util');
...
exports = MDCSimpleMenuFoundation;