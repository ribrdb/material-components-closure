goog.module('mdc.checkbox.foundation');
...
const MDCCheckboxAdapter = goog.require('mdc.checkbox.adapter');
...
const {
  ...
  strings,
  numbers,
} = goog.require('mdc.checkbox.constants');
