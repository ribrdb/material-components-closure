 ...
 * @suppress {checkTypes}
 */
import {captureHandlers, verifyDefaultAdapter} from 'goog:mdc.test.unit.helpers.foundation';
import {setupFoundationTest} from 'goog:mdc.test.unit.helpers.setup';
import {createMockRaf} from 'goog:mdc.test.unit.helpers.raf';
import MDCSimpleMenuFoundation from 'goog:mdc.menu.simple.foundation';
import {cssClasses, strings, numbers} from 'goog:mdc.menu.simple.constants';
