 ...
 * @suppress {checkTypes}
 */
import {MDCSimpleMenu} from 'goog:mdc.menu.simple';
import {strings} from 'goog:mdc.menu.simple.constants';
import {getTransformPropertyName} from 'goog:mdc.menu.util';
