...
import MDCRippleFoundation from 'goog:mdc.ripple.foundation';
import {cssClasses, strings, numbers} from 'goog:mdc.ripple.constants';

import {testFoundation} from 'goog:mdc.test.unit.ripple.helpers';
