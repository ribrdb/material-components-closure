...
import {supportsCssVariables} from 'goog:mdc.ripple.util';
import {createMockRaf} from 'goog:mdc.test.unit.helpers.raf';
import {MDCCheckbox} from 'goog:mdc.checkbox';
import {MDCRipple} from 'goog:mdc.ripple';
import {strings} from 'goog:mdc.checkbox.constants';
import {getCorrectEventName} from 'goog:mdc.animation';
import {getMatchesProperty} from 'goog:mdc.ripple.util';
